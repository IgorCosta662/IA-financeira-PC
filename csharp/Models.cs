...
namespace FinancaAI.Models
{
    ...
    // Debtor representation (Devedores / Quem te deve)
    ...
    // Creditor representation (Credores / Quem você deve)
    ...
    // SecuritySettings representation
    ...
    // Combined financial state context to save/load
    ...
    // AI Request matching the Node.js frontend requests
